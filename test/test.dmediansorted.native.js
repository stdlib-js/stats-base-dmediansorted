...
var dmediansorted = tryRequire( resolve( __dirname, './../lib/dmediansorted.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 3', opts, function test( t ) {
	t.strictEqual( dmediansorted.length, 3, 'has expected arity' );
	t.end();
});
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN`', opts, function test( t ) {
	...
	v = dmediansorted( 0, x, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );

	v = dmediansorted( -1, x, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );
